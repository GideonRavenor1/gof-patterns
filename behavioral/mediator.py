...
Когда используется паттерн Посредник?
    ...
    1. Когда имеется множество взаимосвязанных объектов, связи между которыми
    сложны и запутаны.

    2. Когда необходимо повторно использовать объект, однако повторное
    использование затруднено в силу сильных связей с другими объектами.

Недостатки: Может сильно усложнить код паттерного класса.
"""
